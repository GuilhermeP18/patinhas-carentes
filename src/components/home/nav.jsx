    ...
    <div>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a
            href="/"
            className="cursor-pointer text-gray-400 hover:text-[#3a3a3a] transition-all duration-200 font-medium"
          >
            Sair
          </a>
        </div>
      ...
      <div
        className={`md:hidden bg-white border-b border-gray-200 overflow-hidden transition-all duration-300 ease-in-out ${isMenuOpen ? "max-h-60 opacity-100" : "max-h-0 opacity-0"}`}
      >
        <div className="px-4 py-6 flex flex-col gap-4 shadow-lg">
          ...
          <a
            href="/"
            className="w-full text-center text-gray-400 py-2 font-medium hover:text-[#3a3a3a] transition-colors"
          >
            Sair
          </a>
        </div>
